...
copy /b Microsoft.DesktopAppInstaller_2024.326.2005.0_neutral_~_8wekyb3d8bbwe.Msixbundle.part* Microsoft.DesktopAppInstaller_2024.326.2005.0_neutral_~_8wekyb3d8bbwe.Msixbundle
...
for /f %%i in ('dir /b *UI.Xaml.2.8_*.appx 2^>nul ^| find /i "x64"') do set "UIXaml8X64=%%i"
for /f %%i in ('dir /b *UI.Xaml.2.8_*.appx 2^>nul ^| find /i "x86"') do set "UIXaml8X86=%%i"
...
if /i %arch%==x64 (
set "DepStore=%VCLibsX64%,%VCLibsX86%,%Framework2X64%,%Framework2X86%,%Runtime2X64%,%Runtime2X86%,%UIXaml4X64%,%UIXaml4X86%,%UIXaml8X64%,%UIXaml8X86%,%VCLibsUWPX64%,%VCLibsUWPX86%"
set "DepPurchase=%VCLibsX64%,%VCLibsX86%,%Framework2X64%,%Framework2X86%,%Runtime2X64%,%Runtime2X86%,%UIXaml8X64%,%UIXaml8X86%,%VCLibsUWPX64%,%VCLibsUWPX86%"
set "DepXbox=%VCLibsX64%,%VCLibsX86%,%Framework2X64%,%Framework2X86%,%Runtime2X64%,%Runtime2X86%"
set "DepInstaller=%VCLibsUWPX64%,%VCLibsUWPX86%,%UIXaml8X64%,%UIXaml8X86%"
) else (
set "DepStore=%VCLibsX86%,%Framework2X86%,%Runtime2X86%,%UIXaml4X86%,%UIXaml8X86%,%VCLibsUWPX86%"
set "DepPurchase=%VCLibsX86%,%Framework2X86%,%Runtime2X86%,%VCLibsUWPX86%"
set "DepXbox=%VCLibsX86%,%Framework2X86%,%Runtime2X86%"
set "DepInstaller=%VCLibsUWPX86%,%UIXaml8X86%"
)
